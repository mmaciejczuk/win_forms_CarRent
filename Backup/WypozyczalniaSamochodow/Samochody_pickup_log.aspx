<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ClientLog.Master" AutoEventWireup="true" CodeBehind="Samochody_pickup_log.aspx.cs" Inherits="WypozyczalniaSamochodow.Samochody_pickup_log" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent2" runat="server">
    ...
    <table class="style1">
        ...
        <tr>
            <td>
                <strong>SAMOCHODY PICKUP</strong></td>
        </tr>
        <tr>
            <td>
                <hr></td>
        ...
        <tr>
            <td>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    WHERE (rodzaj_nadwozia LIKE '3') OR (id_cennika LIKE '4')
